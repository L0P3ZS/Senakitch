...
<head>
    ...
    <link rel="stylesheet" href="{{ asset('css/correc.css') }}">
                    ...
                    <div class="card-body">
                        ...
                        <form method="POST" action="{{ route('password.email') }}">
                            ...
                            <div class="form-group row">
                                <label type="email" for="email" class="col-md-4 col-form-label text-md-right">{{ __('Dirección de correo electrónico') }}</label>
