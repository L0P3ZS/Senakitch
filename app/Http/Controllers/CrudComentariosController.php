...
class CrudComentariosController extends Controller
{
    /**
    ...
    public function index()
    {
        ...
        return view('Cruds.crudOpiniones',compact('comentarios'));
    }
    ...
    {
        $comentarios->description = $request->description;
        $comentarios->save();

        return redirect('crudComentarios');
    }
